...
Ansible role for Elasticsearch5 HTTP node.  Currently this works on Debian based linux systems. 

* Debian 

The Elasticsearch versions of 5.1.1 is actively tested.  **Only Ansible versions > 2.1.2 are supported.**
